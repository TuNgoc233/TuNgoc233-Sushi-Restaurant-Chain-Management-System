...
namespace Sushi_Restaurant.Chi_Nhanh
{
    public partial class SampleView : Form
    {
        ...
        public virtual void txtTimKiem_TextChanged(object sender, EventArgs e)
        {

        }

        public virtual void btnThem_Click(object sender, EventArgs e)
        {
        ...
        private void SampleView_Load_1(object sender, EventArgs e)
        {
